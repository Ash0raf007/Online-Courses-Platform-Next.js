...
export const EmailTemplate = ({
	...
	<Html>
		<Head />
		<Preview>
			The Online courses Platform For Yout Digital Products search now for your future
		</Preview>
		<Body style={main}>
			<Container style={container}>
				...
				<Text style={paragraph}>
					Thank you purchasing Click on Below download button to download the all digital content
				</Text>
